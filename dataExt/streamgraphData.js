 ...
 * @default
 */
const ACTIVE_TRACE_MAX_DOMAINS = 100;
/**
 * <pre>
 ...
 * @property {string} urlname url of visited item
 * @property {string} visitStartTime  start time (format DD/MM/YY HH:MM)
 * @property {string} visitEndTime end time  (format DD/MM/YY HH:MM)
 */
/**
