...
var yAxisr = d3.svg.axis()  //right y-axis
    .scale(y);
...
//        return j != i ? 0.6 : 1;
    ...
    .on("mousemove", function(d, i) {
      ...
      tooltip.html( "<p>" + d.key + "<br>" + pro + " " + retlabel + "</p>" ).style("visibility", "visible");
  ...
  d3.select(".chart")
	...
	.style("left", "400px")
	.style("top", "10px")
	.on("click", function() {return updateChart("dwell");})
  ...
  d3.select(".chart")
	...
	.style("left", "300px")
	.style("top", "10px")
	.on("click", function() {return updateChart("visit");})
